...
WebUI.setText(findTestObject('Object Repository/Page_Facebook/input_Email address or phone number_email'), phoneNumber)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Facebook/input_Password_pass'), 'pZdBU03slFiZGyOUv8e8JQ==')
